package br.com.feiraoonline.feirao.email;
...
public class EnviaEmailTLS {
	 public static boolean sendEmail(Mensagem msg) {
	        ...
	        final String password = "vynxdoebbwpscxmd";
	        ...
	        try {
	            ...
	            message.setSubject(t.getAssunto() + "/" + t.getTipoContato());
	            message.setText("Nome: "+t.getNome()+ " "+ t.getSobrenome() +"\n" +
